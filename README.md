...
- [Dragon Data Modules](#dragon-data-modules)
  ...
  - [Current Modules \& Bounties](#current-modules--bounties)
    - [Sniper Analysis](#sniper-analysis)
...
The details for the Module (Sniper Analysis) are outlined below:

### Sniper Analysis
- **Build:** Sniper Analysis
- **Bounty:** 0.xx% of $DRAGON supply
- **Details:**
  The front-end is built. Your task is to integrate an RPC pipeline via our Helius node to gather sniper-related data such as the total number of snipers active, the total percentage sniped still active, timestamps of sniper actions, and more.
